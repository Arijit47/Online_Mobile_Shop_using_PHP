	       ...
	       <div class="contact-info">
	           <h2 class="title">Contact Info</h2>
	            ...
	            <div><h2 class="title">Follow Us On&#58;</h2>
                   <a href="https://www.facebook.com/" target="_blank"><img src="./img/logofb.png" alt="fb logo" style="width:30px; height:30px; border:0"></a>
                   <a href="https://twitter.com/?lang=en" target="_blank"><img src="./img/logotwitter.png" alt="twitter logo" style="width:30px; height:30px; border:0 padding-left:10px;"></a>
               </div>
            </div>
        </div>
    </div>
